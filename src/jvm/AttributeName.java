...
import static jvm.AttributeType.BOOTSTRAP;
import static jvm.AttributeType.FIXED;
import static jvm.Context.*;

public enum AttributeName implements Attribute {
    ...
    RuntimeVisibleParameterAnnotations(Feature.annotations,EnumSet.of(METHOD),ARRAY, AttributeEntry.ANNOTATION),
    RuntimeInvisibleParameterAnnotations(Feature.annotations,EnumSet.of(METHOD),ARRAY, AttributeEntry.ANNOTATION),
    ...
    AnnotationDefault(Feature.annotations,EnumSet.of(METHOD),FIXED, AttributeEntry.ANNOTATION),
    BootstrapMethods(Feature.invokeDynamic,EnumSet.of(CLASS),BOOTSTRAP),
    ...
    private AttributeName(boolean unique,Feature feature, EnumSet<Context> where, AttributeType type, AttributeEntry... entries) {
        this.unique = unique;
