...
public enum Message {
    ...
    M17(BLANK,"prints constant pool"),
    ...
    M505("maximun bootcp used by constatnt pool (%d)  is greater than supplied in attribute (%d)"),
    ...
    M520("CP index %d is not in [0,%d]"),
    M521("CP UTF8 truncated from %d to %d"),
